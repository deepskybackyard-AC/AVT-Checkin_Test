# AVT Check-in 0.3.0-test.4 – Mehrgeräte-Test
...
6. Im Frontend die bisherige `/exec`-URL wieder in `js/config.js` eintragen,
   `enabled: true` setzen und Version 0.3.0-test.4 nach GitHub hochladen.


## Aktualisierung auf 0.3.0-test.4
...
3. Frontend 0.3.0-test.4 nach GitHub hochladen.
